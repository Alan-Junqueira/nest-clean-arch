/*
  ...
  - You are about to drop the column `stline` on the `questions` table. All the data in the column will be lost.
...
*/
-- DropIndex
DROP INDEX "questions_stline_key";

-- AlterTable
ALTER TABLE "questions" DROP COLUMN "stline",
