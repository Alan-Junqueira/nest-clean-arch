...
describe("WatchedList", () => {
  ...
  it("Should be able to add new items to the list", () => {
    ...
    expect(list.getNewItems().at(-1)).toEqual(4);
  });
  ...
  it("Should be able to remove items from the list", () => {
    ...
    expect(list.currentItems.at(-1)).toEqual(3);
  });
  ...
  it("Should be able add an item even if it was removed before", () => {
    ...
    expect(list.currentItems).toHaveLength(3);
    expect(list.getItems().at(-1)).toEqual(2);
  ...
  it("Should be able remove an item even if it was added before", () => {
    ...
    expect(list.currentItems).toHaveLength(3);
    expect(list.getItems().at(-1)).toEqual(3);
  ...
  it("Should be able to update watched list items", () => {
    ...
    expect(list.currentItems).toHaveLength(3);
    expect(list.getItems().at(-1)).toEqual(5);
